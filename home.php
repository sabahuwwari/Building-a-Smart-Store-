...
<!-- Image header -->
  <header class="w3-display-container w3-wide" id="home">
    <img class="w3-image" src="store14.png" alt="store" width="1600" height="1060">
...
<h1>Recently Added</h1>
       <div class="row">
        <?php foreach($row as $product) { ?>
      	<div class="col-md-3">
      		<a href="showproduct.php?productid=<?php echo $product['product_id']; ?>">
           <img class="img-responsive img-thumbnail" src="./bootstrap/img/<?php echo $product['product_image']; ?>">
          </a>
      	</div>
        <?php } ?>
      </div>
