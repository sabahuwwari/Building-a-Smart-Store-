...
<h1>Signin to see whats new</h1>
<p style="color:deeppink;"><b>Cant wait to show you the new offers!</b></p>
           <img class="w3-imagegd w3-right" src="store20.png" style="  margin:40px; padding:4px; width:30%;">
		   
<form class="form-vertical" method="post" action="log.php">
<fieldset >
