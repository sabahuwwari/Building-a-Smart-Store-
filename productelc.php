...
<?php
  ...
  $query = "SELECT * FROM electronics WHERE product_id = '$product_id'";
...
?>
      ...
      <p class="lead" style="margin: 25px 0  "><a href="electronics.php">Electronics </a> >> <?php echo $row['product_name']; ?></p>
