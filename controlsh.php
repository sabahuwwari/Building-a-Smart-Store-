...
<form class="form-horizontal" method="post" action ="checksh.php" >

													   
													    <div class="form-group">
			<label for="password" class="control-label col-md-4">Item ID</label>
			<div class="col-md-4">
			...
			<label for="name" class="control-label col-md-4">Min Value</label>
			<div class="col-md-4">
				<input type="text" name="value" id="value" class="form-control" onkeyup="check()">
			</div>
		</div>
		<br>
...
<script>
	function check(){
		if(document.getElementById("value").value=="" || document.getElementById("id").value=="")
