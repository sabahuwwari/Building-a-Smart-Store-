...
<h1>Add discounts in your sections</h1>
<br><br>

	<form class="form-horizontal" method="post" action ="add.php" >

                                                       <div class="form-group">
			<label for="name" class="control-label col-md-4">Section ID</label>
			<div class="col-md-4">
				<input type="text" name="section" id="section" class="form-control" onkeyup="check()">
			</div>
		</div>
		                <div class="form-group">
			<label for="email" class="control-label col-md-4">Discount Value</label>
			<div class="col-md-4">
				<input type="text" name="discount"  id="discount" class="form-control" onkeyup="check()">
			</div>
		</div>
		<br>

    <input type="submit" name="submit" id="submit" class="w-button w3-pink" disabled>
	</form>

<script>
	function check(){
		if( document.getElementById("section").value==""|| document.getElementById("discount").value=="" )
